...
public final class VSPokerBOT {
    ...
    public static void main(final String[] paramList) {
        ...
        if (paramList.length < PARAM_SIZE) {
            System.out.println("Call with parameter. (ex.: java -jar pokerbot.vs.jar \"foo.irc.net\" \"1234\" \"#your-channel\")");
            return;
        }
     ...
     * BOTのニックネーム
     */
    private static final String BOT_NAME = "VSPokerBOT";
